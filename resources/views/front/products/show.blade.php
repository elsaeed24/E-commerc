                ...
                <div class="col-lg-10 col-md-12 col-lg-offset-1">
                  <div class="ps-product__thumbnail">
                    ...
                    @forelse ($product->images as $image)
                      ...
                      @empty
                      <div class="ps-product__main-img"><img src="{{ $product->image_url }}" alt="ahmed"></div>
                      @endforelse
                    </div>
                  </div>
                  ...
                  <div class="ps-product__info">
                    ...
                    <div class="ps-product__shopping">
                        {{-- <a  class="ps-btn mb-10" href="javascript:;" onclick="document.getElementById('addToCart').submit()">{{ trans('Add to cart') }}<i class="ps-icon-next"></i></a> --}}
                        <a id="add-to-card" class="ps-btn mb-10" href="#">{{ trans('Add to cart') }}<i class="ps-icon-next"></i></a>
