    ...
    <div class="ps-cart__listing">
        <div class="ps-cart__content" id="cart-list">
            ...
            <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                <div class="ps-cart-item__thumbnail"><a href="{{ route('front.products.show', $item->product->slug) }}"></a><img src="{{ $item->product->image_url }}" alt=""></div>
                <div class="ps-cart-item__content"><a class="ps-cart-item__title" href="{{ route('front.products.show', $item->product->slug) }}">{{ $item->product->name }}</a>
